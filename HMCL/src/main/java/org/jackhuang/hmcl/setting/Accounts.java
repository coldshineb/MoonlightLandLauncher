...
public final class Accounts {
    ...
    public static final BoundAuthlibInjectorAccountFactory FACTORY_LITTLE_SKIN = getAccountFactoryByAuthlibInjectorServer(new AuthlibInjectorServer("https://gennokiokuauth.stomt.world/api/yggdrasil/"));
    ...
    static void init() {
        ...
        if (!config().isAddedLittleSkin()) {
            AuthlibInjectorServer littleSkin = new AuthlibInjectorServer("https://gennokiokuauth.stomt.world/api/yggdrasil/");
