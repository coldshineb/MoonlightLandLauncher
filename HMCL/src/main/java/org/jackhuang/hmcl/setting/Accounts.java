...
public final class Accounts {
    ...
    public static final BoundAuthlibInjectorAccountFactory FACTORY_LITTLE_SKIN = getAccountFactoryByAuthlibInjectorServer(new AuthlibInjectorServer("https://auth.gennokioku.stomt.world/api/yggdrasil/"));
