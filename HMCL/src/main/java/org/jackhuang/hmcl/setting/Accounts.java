...
public final class Accounts {
    ...
    public static final BoundAuthlibInjectorAccountFactory FACTORY_LITTLE_SKIN = getAccountFactoryByAuthlibInjectorServer(new AuthlibInjectorServer("https://auth.gennokioku.city/api/yggdrasil/"));
    ...
    static void init() {
        ...
        if (!config().isAddedLittleSkin()) {
            AuthlibInjectorServer littleSkin = new AuthlibInjectorServer("https://auth.gennokioku.city/api/yggdrasil/");
